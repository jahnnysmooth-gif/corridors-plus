...
const HEADERS = [
  ...
  'On Hand', 'Min Stock',
  'Last Delivery Date', 'Last Delivery Qty', 'Delivered By',
  'To Order', 'Order Status', 'Ordered By',
  'Link', 'Notes'
];
...
function setup() {
  ...
  //          Last Delivery Date | Last Delivery Qty | Delivered By |
  //          To Order | Order Status | Ordered By | Link | Notes
  const data = [
    HEADERS,
    // Plaster
    ...
    ['Electrical','1/2" EMT LR','','Pieces',30,'','','','','','','','https://www.lightbulbwholesaler.com/topaz-elr1','-'],
    ['Electrical','1/2" EMT LL','','Pieces',30,'','','','','','','','https://www.lightbulbwholesaler.com/topaz-ell1','-'],
    ...
    ['Misc.','Frog Tape','','Multi-Pack',15,'','04/28/2025',15,'jv','','','','https://www.homedepot.com/p/FrogTape-Pro-Grade-1-41-in-x-60-yds-Blue-Painter-s-Tape-with-PaintBlock-4-Pack-104982/312886403','-'],
